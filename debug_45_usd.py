...
"""
import sys
sys.path.insert(0, '/home/user/personal_finances')

from datetime import date
from backend.database import SessionLocal
from backend.models import Category, BudgetMonth, Currency
from backend.services.budget_service import calculate_available, get_month_budget
    ...
    try:
        ...
        for category in savings_45:
            ...
            for i, budget in enumerate(budgets, 1):
                ...
                from backend.services.budget_service import get_previous_budget
