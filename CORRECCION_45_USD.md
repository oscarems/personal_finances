...
python fix_missing_initial_currency.py

# Paso 2: Recalcular todos los presupuestos de savings
python fix_savings_double_count.py
```
...
- `backend/services/budget_service.py`: Corregida lógica de `calculate_available()`
- `fix_missing_initial_currency.py`: Script para actualizar categorías
- `fix_savings_double_count.py`: Script para recalcular presupuestos
- `debug_45_usd.py`: Script de debugging para análisis
