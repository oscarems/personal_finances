...
**Ubicación en código:**
- Script: `src/finance_app/scripts/seed_categories.py`
- Endpoint API: POST `/api/categories/seed` (líneas 327-426 en `src/finance_app/api/categories.py`)
- Banner UI: `src/finance_app/templates/transactions.html` (líneas 21-49)
...
**Ubicación en código:**
- Frontend: `src/finance_app/templates/budget.html` líneas 71-84
- Backend: Usa endpoint PATCH `/api/categories/{id}` (líneas 203-255 en `src/finance_app/api/categories.py`)
...
**Ubicación en código:**
- Backend: `src/finance_app/api/reports.py` - Funciones helper `get_exchange_rate()` y `convert_to_currency()` (líneas 17-46)
...
2. Desde terminal con `python src/finance_app/scripts/seed_categories.py` o `python src/finance_app/scripts/init_db.py`
...
|----------|--------|------------------|
| Error BD initial_amount | ✅ Resuelto | `python src/finance_app/scripts/migrate_db.py` |
